...
export const createCustomerSchema = z.object({
    ...
    unitNumber: z.string().max(100).optional().nullable(),
    buildingName: z.string().max(255).optional().nullable(),
    ...
    shippingUnitNumber: z.string().max(100).optional().nullable(),
    shippingBuildingName: z.string().max(255).optional().nullable(),
    shippingStreet: z.string().max(255).optional().nullable(),
    shippingArea: z.string().max(255).optional().nullable(),
